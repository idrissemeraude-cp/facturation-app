...
// Données fictives (idéalement à tirer de Supabase)
const INVOICES = [
  { id: '1', number: 'FAC-2024-001', client: 'TechAfrica Studio', issueDate: '01/10/2024', dueDate: '15/10/2024', amount: 450000, status: 'paid' },
  { id: '2', number: 'FAC-2024-002', client: 'Digital SN', issueDate: '05/10/2024', dueDate: '20/10/2024', amount: 120000, status: 'sent' },
  { id: '3', number: 'FAC-2024-003', client: 'AgriCorp', issueDate: '15/09/2024', dueDate: '30/09/2024', amount: 850000, status: 'overdue' },
  { id: '4', number: 'FAC-2024-004', client: 'Startup CI', issueDate: '10/10/2024', dueDate: '25/10/2024', amount: 320000, status: 'draft' },
  { id: '5', number: 'FAC-2024-005', client: 'Boutique Express', issueDate: '12/10/2024', dueDate: '27/10/2024', amount: 45000, status: 'paid' },
];
